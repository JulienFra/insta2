...
<body class="font-sans text-gray-900 antialiased bg-gray-100 dark:bg-gray-900 flex items-center justify-center min-h-screen">
    <div class="container mx-auto">
        <div class="flex flex-col items-center space-y-10">
            <nav class="flex justify-between items-center py-2 w-full">
                <div>
                    <a href="/" class="group font-bold text-3xl flex items-center space-x-4 hover:text-emerald-600 transition">
                        ...
                        <span class="text-xl font-semibold">Mon blog</span>
                    </a>
                </div>
